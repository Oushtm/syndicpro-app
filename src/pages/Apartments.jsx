...
const Apartments = () => {
    ...
    const { isRTL } = useUI();
    const { apartments, loadingDetailed } = useData();
                ...
                {isFormOpen && (
                    <div style={{
                        ...
                        <motion.div
                            ...
                            className="card"
                            style={{
                                width: '100%', maxWidth: '500px', margin: '2rem', maxHeight: '90vh', overflowY: 'auto',
                                background: 'var(--bg-card)', padding: '2rem', borderRadius: '1.5rem'
                            }}
                        >
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                                <h3 style={{ margin: 0 }}>{editingApt ? t('apartments.edit_unit') : t('apartments.add_new')}</h3>
                                <button onClick={() => setIsFormOpen(false)} style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'var(--text-primary)' }}>
                                    <X size={24} />
                                </button>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                                    <div>
                                        <label style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.9rem', fontWeight: 600 }}>{t('apartments.unit_number')}</label>
                                        <input
                                            required
                                            ...
                                            placeholder="A-101"
                                            className="input-field"
                                            style={{ width: '100%', padding: '0.75rem', borderRadius: '0.5rem', border: '1px solid var(--border-light)', background: 'var(--bg-input)', color: 'var(--text-primary)' }}
                                        />
                                    </div>
                                    <div>
                                        <label style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.9rem', fontWeight: 600 }}>{t('apartments.floor')}</label>
                                        <input
                                            required
                                            type="number"
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                                    <div>
                                        <label style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.9rem', fontWeight: 600 }}>{t('apartments.resident_name')}</label>
                                        <input
                                            required
                                    ...
                                    <div>
                                        <label style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.9rem', fontWeight: 600 }}>{t('apartments.cin')}</label>
                                        <input
                                ...
                                <div>
                                    <label style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.9rem', fontWeight: 600 }}>{t('common.phone')}</label>
                                    <input
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                                    <div>
                                        <label style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.9rem', fontWeight: 600 }}>{t('apartments.occupancy_type')}</label>
                                        <select
                                    ...
                                    <div>
                                        <label style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.9rem', fontWeight: 600 }}>{t('common.status.label')}</label>
                                        <select
                                ...
                                {formData.occupancyType === 'shared' && (
                                    <div style={{ border: '1px solid var(--border-light)', padding: '1rem', borderRadius: '0.75rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                                        <label style={{ fontSize: '0.9rem', fontWeight: 700 }}>{t('apartments.roommates')}</label>
                                        <div style={{ display: 'flex', gap: '0.5rem' }}>
                                            {[2, 3, 4].map(count => (
                                                <button
                                                    key={count}
                                        ...
                                        {formData.roommates.map((rm, idx) => (
                                            <div key={idx} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.5rem', padding: '0.75rem', background: 'var(--bg-active)', borderRadius: '0.5rem' }}>
                                                <input
                                ...
                                <div style={{ background: 'var(--primary-bg)', padding: '1rem', borderRadius: '1rem', border: '1px dashed var(--primary)' }}>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.5rem' }}>
                                        <label style={{ fontSize: '0.9rem', fontWeight: 700, color: 'var(--primary)' }}>{t('apartments.monthly_total')}</label>
                                        <div style={{ position: 'relative' }}>
                                            <input
                                                ...
                                                className="input-field"
                                                style={{ width: '120px', textAlign: 'right', paddingInlineEnd: '2.5rem' }}
                                            />
                                            <span style={{ position: 'absolute', [isRTL ? 'left' : 'right']: '0.75rem', top: '50%', transform: 'translateY(-50%)', fontWeight: 800, fontSize: '0.8rem', opacity: 0.5 }}>MAD</span>
                                        </div>
                                    </div>
                                ...
                                <button
                                    ...
                                    style={{ marginTop: '1rem', width: '100%', justifyContent: 'center', height: '3rem', borderRadius: '0.75rem', fontWeight: 700 }}
                                >
